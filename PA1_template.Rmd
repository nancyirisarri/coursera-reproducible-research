...
The mean for the original dataset is `r meanResult` while for the imputed dataset is `r meanFilled`. This is a difference of `r meanFilled-meanResult`. Meanwhile the median for the original and imputed dataset is `r medianResult` and `r medianFilled`, respectively. Thus the change in the median is `r medianFilled-medianResult`. The impact in both the mean and median of imputing missing data with the chosen strategy is an increase in the estimates of the total daily number of steps.
